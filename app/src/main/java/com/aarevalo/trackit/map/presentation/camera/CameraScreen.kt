...
import com.aarevalo.trackit.core.presentation.utils.hasCameraPermission
import com.aarevalo.trackit.core.presentation.utils.shouldShowCameraRationalePermission
import com.aarevalo.trackit.map.data.camera.toBitMap
import com.aarevalo.trackit.map.data.camera.toByteArray
        ...
        when {
            uiState.isInPreviewMode && previewPhoto != null -> {
                PhotoPreviewScreen(
                    ...
                    onSave = {
                        viewModel.onAction(
                            CameraScreenAction.SavePicture
                        )
                    },
                    onCancel = {
                        viewModel.onAction(
                            CameraScreenAction.CancelPreview
                        )
                    })
            }
                ...
                CameraScreen(
                    ...
                    onPhotoTaken = { imageProxy ->
                        ...
                        viewModel.onAction(
                            CameraScreenAction.TakenPicture(
...
fun CameraScreen(
    ...
    val permissionLauncherCamera = rememberLauncherForActivityResult(
        ...
        val hasCameraPermission = activity.hasCameraPermission()
        ...
        onAction(
            CameraScreenAction.SubmitCameraPermissionInfo(
                ...
                shouldShowCameraRationale = showCameraRationale
            )
        )
    }
